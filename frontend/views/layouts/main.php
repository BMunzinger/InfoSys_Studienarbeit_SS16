...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <div class="wrap">
            <?php
            NavBar::begin([
                'brandLabel' => '<img src="logo.png" height="60px" style="margin-top: -10px;" id="logo"/>',
            ...
            $menuItems = [
                ...
                ['label' => 'Hauptmenü', 'url' => ['/site/tiles']],
                ['label' => 'News', 'url' => ['/site/news']],
                ['label' => 'Stundenplan', 'url' => ['/site/kursplanview']],
            ...
            echo Breadcrumbs::widget([
                ...
                'homeLink' => ['label' => 'Startseite', 'url' => ['/site/index']],
            ])
            ?>
        ...
        <footer class="footer">
            <div class="container">
                <marquee direction="left" class="newsTicker">
                    <?php
                    $tickermeldungen = Tickermeldungen::find()->where(['Ablaufdatum' => date('Y-m-j')])->all();

                    foreach ($tickermeldungen as $t) {
                        echo ' +++ ';
                        echo $t->text;
                    }
                    
                    if(sizeOf($tickermeldungen) !== 0) {
                        echo ' +++ ';
                    } else {
